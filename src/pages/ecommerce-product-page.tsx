...
export const EcommerceProductPage = () => {
    ...
    return (
        <>
            <div className="font-KumbhSans min-h-screen relative">
                <header className="pt-[1.31rem] px-[1.48rem] pb-6 flex justify-between">
                    <div className="flex gap-4">
                        <img src="/ecommerce-product-page/menu.svg" alt="menu" />
                ...
                <main>
                    <div className="relative overflow-hidden max-h-[18.75rem]">
                        <img
                    ...
                    <div className="px-6 pt-6 flex flex-col gap-4">
                        <div className="text-[#69707D] text-[0.75rem] font-[700]">Sneaker Company</div>
                        <h1 className="text-[1.75rem] font-[700]">Fall Limited Edition Sneakers</h1>
                        <p className="text-[0.9375rem] font-[400] text-[#69707D]">These low-profile sneakers are your perfect casual wear companion. Featuring a durable rubber outer sole, they’ll withstand everything the weather can offer.</p>
                        <div>
                            <div className="flex justify-between mb-4">
                                <div className="flex items-start gap-4">
                                    <span className="text-[#1D2026] text-[1.75rem] font-[700] leading-[2rem]">$125.00</span>
                                    <span className="rounded-[0.375rem] bg-[#1D2026] font-[700] text-white p-[1px]">50%</span>
                                </div>
                                <div className="text-[#69707D] line-through font-[700]">$250.00</div>
                            </div>
                            <div className="flex justify-between rounded-[0.625rem] bg-[#F6F8FD] p-4 items-center">
                                <img
                        ...
                        <button
                            className="rounded-[0.625rem] bg-[#FF7E1B] py-4 px-[6.5rem]"
